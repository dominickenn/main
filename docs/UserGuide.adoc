...
_{ To explain what a user account feature is. }
...
* [example]#`signup u/david p/david123`#
* [example]#`signup u/mary91 u/ilovecats465`#
====

==== Logging in : `login` or `log`
Login to a PrioriTask account +
...
* [example]#`login u/david p/david123`#
* [example]#`login u/mary91 u/ilovecats465`#
====
