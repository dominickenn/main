...
Creating a user account for PrioriTask +
...
* [example]#`signup u/david p/david19483`#
* [example]#`signup u/mary123 p/04sally04`#
====
...
=== User Features
* *Sign Up* : [format]#` u/USERNAME p/PASSWORD`# +
e.g. [example-no-box]#`signup u/david p/david19438`#
