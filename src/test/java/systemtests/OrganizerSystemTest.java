...
public abstract class OrganizerSystemTest {
    ...
    private void assertApplicationStartingStateIsCorrect() {
        try {
            ...
            assertEquals(String.format(CURRENT_USER_STATUS_UPDATED, getModel().getOrganizer().getCurrentUserTaskList().size()),
    ...
    protected void assertStatusBarChangedExceptSaveLocation() {
        ...
        assertEquals(String.format(CURRENT_USER_STATUS_UPDATED, totalTasks), handle.getCurrentUserStatus());
