...
public class XmlOrganizerStorageTest {
    ...
    @Test
    public void readOrganizer_invalidPersonOrganizer_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readOrganizer("invalidTaskOrganizer.xml");
    }

    @Test
    public void readOrganizer_invalidAndValidPersonOrganizer_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
