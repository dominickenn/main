...
//@@author dominickenn
public class LoginUserCommandParserTest {
    private LoginUserCommandParser parser = new LoginUserCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, USERNAME_DESC_ADMIN + PASSWORD_DESC_ADMIN,
                new LoginUserCommand(expectedUser));
    }

    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, LoginUserCommand.MESSAGE_USAGE);
