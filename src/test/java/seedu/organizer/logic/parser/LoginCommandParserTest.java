...
public class LoginCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE
                        + " u/expectedUser "
                        + "p/expectedUser ", new LoginCommand(expectedUser));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, LoginCommand.COMMAND_WORD + " user p/user", expectedMessage);

        // missing password prefix
        assertParseFailure(parser, LoginCommand.COMMAND_WORD + " u/user user", expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, LoginCommand.COMMAND_WORD + " user user", expectedMessage);
    }
