...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Task expectedTask = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
        ...
        Task expectedTaskMultipleTags = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Task expectedTask = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
